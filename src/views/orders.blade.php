                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <th style="font-size: small" scope="col">
                                    <a href="/admin/set-is_paid?is_paid=all">все</a>@if(cache(session_id() . '_is_paid','all')=='all')
                                        ✔ @endif<br>
                                    <a href="/admin/set-is_paid?is_paid=paid">оплаченные</a>@if(cache(session_id() . '_is_paid','')=='paid')
                                        ✔ @endif<br>
                                    <a href="/admin/set-is_paid?is_paid=not_paid">не
                                        оплаченные</a>@if(cache(session_id() . '_is_paid')=='not_paid')
                                        ✔ @endif
                                </th>
                                <th class="text-center" scope="col">
